 ...
 * <p>
 * First byte contains {@link ShapeType#}. The rest is type specific.
...
public class ShapeSerde {
    ...
    private static int calculateBufferSize(int numPoints, int numParts, int numGrids) {
        return 1 + 4 * ShapeFileConst.DOUBLE_LENGTH + ShapeFileConst.INT_LENGTH + ShapeFileConst.INT_LENGTH + numParts * ShapeFileConst.INT_LENGTH + numPoints * 2 * ShapeFileConst.DOUBLE_LENGTH + ShapeFileConst.INT_LENGTH + numGrids * ShapeFileConst.LONG_LENGTH + 1;
    }
    ...
    private static int calculateTrajectoryBufferSize(int numPoints, int numParts) {
        return 1 + 4 * ShapeFileConst.DOUBLE_LENGTH + ShapeFileConst.INT_LENGTH + ShapeFileConst.INT_LENGTH + numParts * ShapeFileConst.INT_LENGTH + numPoints * 3 * ShapeFileConst.DOUBLE_LENGTH;
    }

    private static int calculateGridTrajectoryBufferSize(int numPoints, int numParts, int numGrids) {
        return 1 + 4 * ShapeFileConst.DOUBLE_LENGTH + ShapeFileConst.INT_LENGTH + ShapeFileConst.INT_LENGTH + numParts * ShapeFileConst.INT_LENGTH + numPoints * 3 * ShapeFileConst.DOUBLE_LENGTH + +ShapeFileConst.INT_LENGTH + numGrids * ShapeFileConst.LONG_LENGTH + 1;
    }
