...
package cn.edu.whu.spatialJoin.formatMapper.shapefileParser.parseUtils.dbf;

import cn.edu.whu.spatialJoin.formatMapper.shapefileParser.parseUtils.shp.ShapeFileConst;
...
public class DbfParseUtil
    ...
    public String primitiveToAttributes(ByteBuffer buffer)
        ...
        for (int i = 0; i < fieldDescriptors.size(); ++i) {
            ...
            String charset = System.getProperty("sql.global.charset", "default");
