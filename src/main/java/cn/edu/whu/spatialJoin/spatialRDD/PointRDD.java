...
import cn.edu.whu.spatialJoin.formatMapper.PointFormatMapper;
...
public class PointRDD
    ...
    public PointRDD(JavaSparkContext sparkContext, String InputLocation, Integer Offset, FileDataSplitter splitter,
        ...
        if (Offset != null) {
            this.setRawSpatialRDD(rawTextRDD.mapPartitions(new PointFormatMapper(Offset, splitter, carryInputData)));
        } else {
