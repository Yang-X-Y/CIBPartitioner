...
package cn.edu.whu.spatialJoin.spatialPartitioning.quadtree;
...
public class StandardQuadTree<T>
    ...
    public QuadRectangle getZone(int x, int y)
        ...
        if (region != REGION_SELF) {
            ...
            throw new ArrayIndexOutOfBoundsException("[SQL][StandardQuadTree] this pixel is out of the quad tree boundary.");
        }
    }
        ...
        if (level < minLevel) {
            ...
            if (region == REGION_SELF) {
                ...
                if (zone.contains(x, y)) {
                    ...
                    throw new Exception("[SQL][StandardQuadTree][getParentZone] this leaf node doesn't have enough depth. " +
                    ...
                    throw new Exception("[SQL][StandardQuadTree][getParentZone] this pixel is out of the quad tree boundary.");
                }
            } else {
